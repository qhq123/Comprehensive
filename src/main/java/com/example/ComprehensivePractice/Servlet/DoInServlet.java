 ...
 */
@WebServlet(name = "DoInServlet", urlPatterns = "/DoInServlet")
public class DoInServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String inerid=ja.getJSONObject(0).getString("inerid");
        InTable intable=new InTable();
        JSONArray res= intable.dobookin(bookid,count,inerid);
